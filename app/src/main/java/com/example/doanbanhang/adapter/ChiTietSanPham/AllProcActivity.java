...
public class AllProcActivity extends AppCompatActivity implements SanPhamAdapter.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=findViewById(R.id.sortallsp);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(co==0){
                    sanphams.clear();
                    sanphams=dbHelper.getallSpsort();
                    RAllProc.setAdapter(new SanPhamAdapter(R.id.rAllPC, AllProcActivity.this, sanphams, AllProcActivity.this));
                    RAllProc.setLayoutManager(new LinearLayoutManager(AllProcActivity.this, LinearLayoutManager.VERTICAL, false));
                    co=1;
                }
                else {
                    sanphams.clear();
                    sanphams=dbHelper.getallSpsort2();
                    RAllProc.setAdapter(new SanPhamAdapter(R.id.rAllPC, AllProcActivity.this, sanphams, AllProcActivity.this));
                    RAllProc.setLayoutManager(new LinearLayoutManager(AllProcActivity.this, LinearLayoutManager.VERTICAL, false));
                    co=0;
                }
